...
function Header() {
  ...
  useEffect(() => {
    // Fetch trendy products from product manager when component mounts
  ...
  // Load cart and wishlist counts from localStorage on component mount
  useEffect(() => {
    const updateCounts = () => {
      // Update cart count
