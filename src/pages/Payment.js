...
const Payment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Save order to bookings in localStorage
    const savedBookings = JSON.parse(localStorage.getItem('bookings') || '[]');
    localStorage.setItem('bookings', JSON.stringify([...savedBookings, order]));
    
    // Dispatch event to notify components of new order
